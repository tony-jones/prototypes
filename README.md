...
Be sure to look over the [installation docs](docs/install.md) to verify your environment is prepared to run this.
Once you have verified that your system can run it, check out the [commands](docs/commands.md) available to get started.
